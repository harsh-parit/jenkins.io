...
. In the navigation pane on the left side, under *NETWORK & SECURITY*, select *Key Pairs*.
...
+
. Make sure to change the directory where the key pair is been downloaded
[source,bash]
----
